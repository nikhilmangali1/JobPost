...
<%@ page import="com.learnspringweb.JobApp.model.JobPost" %>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://www.geeksforgeeks.org/user/nikhilmangali1/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
